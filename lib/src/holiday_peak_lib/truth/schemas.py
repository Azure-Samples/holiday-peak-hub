...
CANONICAL_CATEGORY_SCHEMAS: dict[str, UcpSchema] = {
    ...
    # -------------------------------------------------------------------
    # Extended categories (v1.1.0) — retail amplification
    # -------------------------------------------------------------------
    "automotive": UcpSchema(
        category_id="automotive",
        category_name="Automotive & Powersports",
        version="1.1.0",
        attributes=[
            UcpAttribute(name="brand", label="Brand", required=True),
            UcpAttribute(name="part_number", label="Part Number", required=True),
            UcpAttribute(
                name="vehicle_compatibility", label="Vehicle Compatibility", data_type="list"
            ),
            UcpAttribute(name="material", label="Material"),
            UcpAttribute(name="weight_kg", label="Weight (kg)", data_type="number"),
            UcpAttribute(name="dimensions_cm", label="Dimensions (cm)", data_type="object"),
            UcpAttribute(name="warranty_months", label="Warranty (months)", data_type="number"),
            UcpAttribute(name="certification", label="Certification"),
        ],
    ),
    "garden_outdoor": UcpSchema(
        category_id="garden_outdoor",
        category_name="Garden & Outdoor Living",
        version="1.1.0",
        attributes=[
            UcpAttribute(name="brand", label="Brand", required=True),
            UcpAttribute(name="material", label="Material", required=True),
            ...
            UcpAttribute(name="weather_resistance", label="Weather Resistance"),
            UcpAttribute(name="assembly_required", label="Assembly Required", data_type="boolean"),
            UcpAttribute(name="power_source", label="Power Source"),
            UcpAttribute(name="color", label="Color"),
        ],
    ),
    "office_supplies": UcpSchema(
        ...
        attributes=[
            ...
            UcpAttribute(name="material", label="Material"),
            UcpAttribute(name="color", label="Color"),
            UcpAttribute(name="pack_quantity", label="Pack Quantity", data_type="number"),
            UcpAttribute(name="dimensions_cm", label="Dimensions (cm)", data_type="object"),
            UcpAttribute(name="eco_certified", label="Eco Certified", data_type="boolean"),
        ],
    ),
    "health_wellness": UcpSchema(
        category_id="health_wellness",
        category_name="Health & Wellness",
        version="1.1.0",
        attributes=[
            UcpAttribute(name="brand", label="Brand", required=True),
            UcpAttribute(name="active_ingredients", label="Active Ingredients", data_type="list"),
            UcpAttribute(name="dosage_form", label="Dosage Form"),
            UcpAttribute(name="quantity", label="Quantity", data_type="number"),
            UcpAttribute(name="allergens", label="Allergens", data_type="list"),
            UcpAttribute(name="expiry_months", label="Shelf Life (months)", data_type="number"),
            UcpAttribute(name="organic", label="Organic", data_type="boolean"),
            UcpAttribute(name="certification", label="Certification"),
    ...
    "baby_kids": UcpSchema(
        ...
        attributes=[
            ...
            UcpAttribute(name="age_range", label="Age Range", required=True),
            UcpAttribute(name="material", label="Material", required=True),
            UcpAttribute(name="safety_certification", label="Safety Certification", required=True),
            UcpAttribute(name="weight_kg", label="Weight (kg)", data_type="number"),
            UcpAttribute(name="gender", label="Gender", allowed_values=["boys", "girls", "unisex"]),
            UcpAttribute(name="bpa_free", label="BPA Free", data_type="boolean"),
        ],
    ),
    "home_appliances": UcpSchema(
        ...
        attributes=[
            ...
            UcpAttribute(name="voltage", label="Voltage", data_type="number"),
            UcpAttribute(name="wattage", label="Wattage", data_type="number"),
            UcpAttribute(name="energy_rating", label="Energy Rating"),
            UcpAttribute(name="capacity", label="Capacity"),
            UcpAttribute(name="weight_kg", label="Weight (kg)", data_type="number"),
            UcpAttribute(name="dimensions_cm", label="Dimensions (cm)", data_type="object"),
            UcpAttribute(name="warranty_months", label="Warranty (months)", data_type="number"),
            UcpAttribute(name="color", label="Color"),
            UcpAttribute(name="noise_level_db", label="Noise Level (dB)", data_type="number"),
        ],
    ),
    "musical_instruments": UcpSchema(
        category_id="musical_instruments",
        category_name="Musical Instruments",
        version="1.1.0",
        attributes=[
            UcpAttribute(name="brand", label="Brand", required=True),
            UcpAttribute(name="instrument_type", label="Instrument Type", required=True),
            UcpAttribute(name="material", label="Material"),
            UcpAttribute(
                name="skill_level",
                label="Skill Level",
                allowed_values=["beginner", "intermediate", "advanced", "professional"],
            ),
            UcpAttribute(name="weight_kg", label="Weight (kg)", data_type="number"),
            UcpAttribute(name="warranty_months", label="Warranty (months)", data_type="number"),
        ],
...
_CATEGORY_ALIASES: dict[str, str] = {
    ...
    "garden": "garden_outdoor",
    "outdoor living": "garden_outdoor",
    "cat-garden-outdoor": "garden_outdoor",
    "office": "office_supplies",
    "school supplies": "office_supplies",
    "cat-office-supplies": "office_supplies",
    "health": "health_wellness",
    "wellness": "health_wellness",
    "cat-health-wellness": "health_wellness",
    "baby": "baby_kids",
    "kids": "baby_kids",
    "cat-baby-kids": "baby_kids",
    "appliances": "home_appliances",
    "cat-home-appliances": "home_appliances",
    "instruments": "musical_instruments",
    "music": "musical_instruments",
    "cat-musical-instruments": "musical_instruments",
}
