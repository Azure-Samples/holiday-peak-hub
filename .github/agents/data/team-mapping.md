...
Agents discovered under `.github/agents/` subdirectories in this repository. These are not exported to other workspaces.

| Agent Name | File | Group |
| --- | --- | --- |
| `Truth_Layer_Foundation` | `.github/agents/Truth_Layer_Foundation.agent.md` | `repo-local` |
| `Truth_Layer_Hardening` | `.github/agents/Truth_Layer_Hardening.agent.md` | `repo-local` |
| `Truth_Layer_Pipeline` | `.github/agents/Truth_Layer_Pipeline.agent.md` | `repo-local` |
