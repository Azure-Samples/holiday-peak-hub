...
For demos requiring realistic volume and diversity, use the [Kaggle Olist loader](../../../scripts/python/ops/load-kaggle-olist-dataset.py):
...
2. Try [API Examples](../api-examples/) (scripts in [`scripts/shell/demos/`](../../../scripts/shell/demos/) and [`scripts/powershell/demos/`](../../../scripts/powershell/demos/))
